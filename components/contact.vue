                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        <form id="contactForm" @submit.prevent="onSubmitFormContact">
                            ...
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" v-model="email" name="email" @input="onChange" id="email" type="email" placeholder="name@example.com"/>
                                <label for="email">Votre adresse mail</label>

                            </div>
                            <!-- Phone number input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" v-model="phone" name="phone" @input="onChange" id="phone" type="tel" placeholder="(123) 456-7890"/>
                                <label for="phone">Numéro de téléphone</label>

                            </div>
                            <!-- Message input-->
                            <div class="form-floating mb-3">
                                <textarea class="form-control" name="message" v-model="message" @input="onChange" id="message" type="text" placeholder="Votre message...." style="height: 10rem"></textarea>
